...
>
    ...
    <div className="w-full xl:w-[50%] xl:h-[460px] flex flex-col xl:justify-between order-2 xl:order-none">
        ...
        >
            ...
            {/* overlay */}
            <div className="absolute top-0 botton-0 w-full h-full bg-black/1- z-10"></div>
            {/* image */}
            ...
            btnStyles="bg-transparent hover:bg-transparent text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all"
            />
        </Swiper>
        </div>
    </div>
